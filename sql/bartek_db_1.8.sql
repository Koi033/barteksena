...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-09-2026 a las 07:51:40
...
--
-- Estructura de tabla para la tabla `configuracion_puntos`
--

CREATE TABLE `configuracion_puntos` (
  `id` int(10) UNSIGNED NOT NULL,
  `modo_acumulacion` enum('dinero','productos') NOT NULL DEFAULT 'dinero',
  `valor_acumulacion` decimal(10,2) NOT NULL DEFAULT 10000.00,
  `puntos_otorgados` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `puntos_bienvenida` int(10) UNSIGNED NOT NULL DEFAULT 5,
  `actualizado_en` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `configuracion_puntos`
--

INSERT INTO `configuracion_puntos` (`id`, `modo_acumulacion`, `valor_acumulacion`, `puntos_otorgados`, `puntos_bienvenida`, `actualizado_en`) VALUES
(1, 'dinero', 10000.00, 10, 50, '2026-09-13 18:49:59');
...
(13, 3, 42, 1, 6500.00, 6500.00),
(14, 3, 43, 2, 10000.00, 20000.00);
...
CREATE TABLE `historial_puntos` (
  ...
  `recompensa_id` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `historial_puntos` (`id`, `nombre`, `cedula_cliente`, `empleado_id`, `mesa`, `recompensa_id`, `cantidad_puntos`, `tipo`, `fecha`) VALUES
(13, 'julio', '1021396059', NULL, NULL, NULL, 10000, 'ganado', '2026-09-14 05:46:53'),
(14, 'julio', '1021396059', 4, '1', 2, 60, 'canjeado', '2026-09-14 05:49:42');
...
(42, 1, 'BEB006', 'Cerveza Club Colombia Dorada 330ml', 47, 12, 6500.00, 1, '2026-09-14 00:49:55', '2026-09-03 15:04:00'),
(43, 1, 'BEB007', 'Cerveza Corona Extra 355ml', 34, 10, 10000.00, 1, '2026-09-14 00:49:55', '2026-09-03 15:04:00'),
...
--
-- Estructura de tabla para la tabla `recompensas_puntos`
--

CREATE TABLE `recompensas_puntos` (
  `id` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `tipo` enum('descuento_categoria','producto_gratis') NOT NULL DEFAULT 'producto_gratis',
...
--
-- Volcado de datos para la tabla `recompensas_puntos`
--

INSERT INTO `recompensas_puntos` (`id`, `nombre`, `tipo`, `categoria_id`, `porcentaje_descuento`, `producto_id`, `descripcion`, `puntos_requeridos`, `activo`, `creado_en`) VALUES
(2, 'Cerveza Gratis', 'descuento_categoria', 1, 20.00, NULL, '20% de descuento en Cervezas', 60, 1, '2026-09-14 00:37:19');
...
CREATE TABLE `ventas` (
  ...
  `descuento_recompensa` decimal(10,2) NOT NULL DEFAULT 0.00,
  `descuento_categoria_acumulado` decimal(10,2) NOT NULL DEFAULT 0.00,
...
INSERT INTO `ventas` (`id`, `empleado_id`, `mesa`, `total`, `descuento_recompensa`, `descuento_categoria_acumulado`, `estado`, `metodo_pago`, `creado_en`, `cerrado_en`) VALUES
(1, NULL, '1', 17.50, 0.00, 0.00, 'cerrado', 'efectivo', '2026-08-08 13:44:17', '2026-09-03 14:58:48'),
(2, 4, '1', 12000.00, 0.00, 0.00, 'cerrado', 'bre_b', '2026-09-03 15:26:27', '2026-09-03 15:26:41'),
(3, 4, '1', 21200.00, 5300.00, 5300.00, 'cerrado', 'efectivo', '2026-09-14 00:43:59', '2026-09-14 00:49:55');
...
--
-- Indices de la tabla `configuracion_puntos`
--
...
--
-- Indices de la tabla `recompensas_puntos`
--
ALTER TABLE `recompensas_puntos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_recompensa_categoria` (`categoria_id`),
...
--
-- AUTO_INCREMENT de la tabla `recompensas_puntos`
--
ALTER TABLE `recompensas_puntos`
...
--
ALTER TABLE `detalle_ventas`
  ADD CONSTRAINT `fk_detalle_inventario` FOREIGN KEY (`inventario_id`) REFERENCES `inventario` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `fk_horarios_empleado` FOREIGN KEY (`empleado_id`) REFERENCES `empleados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `inventario`
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `fk_inventario_categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categorias_menu` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `recompensas_puntos`
--
ALTER TABLE `recompensas_puntos`
  ADD CONSTRAINT `fk_recompensa_categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categorias_menu` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_recompensa_producto` FOREIGN KEY (`producto_id`) REFERENCES `inventario` (`id`) ON DELETE SET NULL;

--
-- Filtros para la tabla `ventas`
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `fk_ventas_empleado` FOREIGN KEY (`empleado_id`) REFERENCES `empleados` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
